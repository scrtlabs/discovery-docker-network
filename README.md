...
| Travis (SGX_MODE=SW) | [![Build Status](https://travis-ci.org/enigmampc/discovery-docker-network.svg?branch=master)](https://travis-ci.org/enigmampc/discovery-docker-network) | [![Build Status](https://travis-ci.org/enigmampc/discovery-docker-network.svg?branch=develop)](https://travis-ci.org/enigmampc/discovery-docker-network) |
